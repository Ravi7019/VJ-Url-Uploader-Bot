...
ᴛʜɪs ʙᴏᴛ ɪs ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href="https://t.me/KannadaFlix6">ᴋᴀɴɴᴀᴅᴀꜰʟɪx</a></b>
"""

    TECH_VJ_HELP_TEXT = """
<b>🖍️ ғᴇᴀᴛᴜʀᴇs :-

🔺 ᴜᴘʟᴏᴀᴅ <a href="https://t.me/KannadaFlix6">ʏᴛ-ᴅʟᴘ sᴜᴘᴘᴏʀᴛᴇᴅ ʟɪɴᴋs</a> ᴛᴏ ᴛᴇʟᴇɢʀᴀᴍ.
...
🔻 ʜᴏᴡ ᴛᴏ ᴜᴘʟᴏᴀᴅ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋs <a href="https://t.me/KannadaFlix6">ᴛᴜᴛᴏʀɪᴀʟ ᴠɪᴅᴇᴏ</a>
...
🌀 ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/KannadaFlix6">ᴋᴀɴɴᴀᴅᴀꜰʟɪx</a>
...
👲 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="https://t.me/Ravikumarcn">ᴋᴀɴɴᴀᴅᴀꜰʟɪx</a></b>
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/KannadaFlix6')
        ], [
    ...
    TECH_VJ_ABOUT_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/Movierequest6_bot'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/KannadaFlix6')
        ], [
            InlineKeyboardButton('🏠 ʜᴏᴍᴇ', callback_data='home'),
            InlineKeyboardButton('❓ ʜᴇʟᴘ', callback_data='help')
        ], [
